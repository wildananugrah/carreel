...
export function Dashboard() {
  ...
  if (!kpis) return <div className="text-center text-gray-500 mt-12">Failed to load dashboard</div>;
  ...
  return (
    <div>
      ...
      {/* Status Distribution */}
      <h2 className="text-lg font-semibold text-gray-900 mb-3">By Status</h2>
