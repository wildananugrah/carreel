...
export type OutboxEventWhereInput = {
  ...
  status?: Prisma.EnumOutboxEventStatusFilter<"OutboxEvent"> | $Enums.OutboxEventStatus
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  status?: Prisma.EnumOutboxEventStatusWithAggregatesFilter<"OutboxEvent"> | $Enums.OutboxEventStatus
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "eventType" | "payload" | "status" | "createdAt", ExtArgs["result"]["outboxEvent"]>
...
export interface OutboxEventFieldRefs {
  ...
  readonly status: Prisma.FieldRef<"OutboxEvent", 'OutboxEventStatus'>
